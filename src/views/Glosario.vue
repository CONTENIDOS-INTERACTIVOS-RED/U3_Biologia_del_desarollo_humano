...
.curso-main-container.glosario
  BannerInterno.text-uppercase(icono="fas fa-atlas" subTitulo="GLOSARIO" titulo="Unidad 3. Desarrollo integral y contextos de aprendizaje en la adultez y la vejez")
