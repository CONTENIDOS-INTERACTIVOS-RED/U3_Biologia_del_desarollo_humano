...
.curso-main-container.referencias
  BannerInterno.text-uppercase(icono="fas fa-book" subTitulo="Referencias bibliográficas" titulo="Unidad 3. Desarrollo integral y contextos de aprendizaje en la adultez y la vejez")
